...
\section{Fleet Composition and Planning Horizon}
\label{sec:Fleet_Composition_and_Planning_Horizon}
...
The planning horizon is defined as a multi-period horizon consistent with typical vehicle lifecycles in urban freight operations. Fleet replacement decisions are made at discrete time intervals, during which vehicles may be acquired, operated, or retired. Vehicle aging, utilization levels, and salvage values are explicitly considered to reflect realistic fleet dynamics.
