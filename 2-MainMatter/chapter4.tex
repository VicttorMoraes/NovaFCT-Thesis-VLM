...
A dedicated routine will be implemented to solve a sequence of MILPs using the $\varepsilon$-constraint method. In each run, the model will minimize expected total cost while enforcing a bound on the risk measure:
\begin{equation}
